...
/* ── Ink: a two-tier cake, drawn ─────────────────────────────────────────────────────────────────
 *
 * The hero art for the INK theme, and its alone. A theme's picture belongs to that theme — the
 * shared 3D cake is exactly why Spotlight, Aurora and Atelier read as one storefront in different
 * clothes, and re-using this drawing anywhere else would rebuild that problem with a nicer line.
 *
