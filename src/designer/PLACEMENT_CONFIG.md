...
```jsonc
{
  ...
  "placement_config": {                                   // HOW it behaves — the FULL superset (= §0).
    ...
    "relief":  { "lift": 0.07, "normalScale": 0.8, "roughness": 0.7, "sheen": 0.12, "envIntensity": 0.4, "toneMapped": false,
                 "bake": { "puff": 0.5, "domeBlur": 34, "edgeRound": 16, "detail": 0.4, "grain": 0.5, "delit": 0, "flipY": false } },  // raised fondant cut-out (admin Relief Studio)
