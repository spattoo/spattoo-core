...
```jsonc
{
  ...
  "placement_config": {                                   // HOW it behaves — the FULL superset (= §0).
    ...
    "relief":  { "lift": 0.07, "normalScale": 0.8, "roughness": 0.95, "sheen": 0, "envIntensity": 0.4, "toneMapped": false, "solid": false, "solidEdge": 0, "solidFinish": "fondant",
