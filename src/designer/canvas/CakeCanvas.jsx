...
//
// ── Why 256 and not 1k ──────────────────────────────────────────────────────────────────────────
// The 1k original is 1.4 MB and loads WITH THE CANVAS — before the cake is on screen — which on
// mobile data was most of the wait. It bought almost nothing: three.js convolves an environment map
// for roughness (PMREM), so the majority of those pixels are averaged away before they light
// anything, and a cake is fondant and buttercream rather than chrome.
//
//   lebombo_1k.hdr   1024×512   1442 KB   the original, still in R2, never overwritten
//   lebombo_512.hdr   512×256    370 KB
//   lebombo_256.hdr   256×128     96 KB   ← 15× smaller
//   lebombo_128.hdr   128×64      25 KB   highlights start to soften
//
// All four are uploaded, so changing the look is THIS LINE and nothing else — no re-export, no
// upload, no deploy of anything but the bundle. If gold leaf or a chocolate drip ever reads as too
// soft, 512 is the step back. Generated by spattoo-api/scripts/downsample-hdr.mjs.
